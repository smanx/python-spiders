#!/usr/bin/python
# -*- coding: UTF-8 -*-
# nohup python -u download_res.py > log.txt 2>&1 &
        ...
        with open('data/' + filename, 'r') as f:
            for line in f:
                ...
                for post in posts:
                    ...
                    urls = []
                    directory = os.path.join("res", uuid)
...
def download_one(res):
    ...
    try:
        ...
        with open(filepath, 'wb') as f:
            ...
            print time.asctime(time.localtime(time.time())), "资源下载完毕", COUNT, ALLCOUNT
